...
func (ec *Client) TransactionByHash(ctx context.Context, hash common.Hash) (from *common.Address, tx *types.Transaction, isPending bool, err error) {
	...
	return json.From, json.tx, json.BlockNumber == nil, nil
}
...
func (ec *Client) SendTransaction(ctx context.Context, tx *types.Transaction) (error, string) {
	...
	error := ec.c.CallContext(ctx, &result, "eth_sendRawTransaction", common.ToHex(data))
...
func (ec *Client) CreateFilter(ctx context.Context, object interface{}) (error, string) {
	...
	error := ec.c.CallContext(ctx, &result, "eth_newFilter", object)
